...
const abi = [{
  ...
  {"internalType":"uint256","name":"daysFromNow","type":"uint256"}],"name":"setExpiry","outputs":[],"stateMutability":"nonpayable","type":"function"
},{
  "inputs":[{"internalType":"address","name":"to","type":"address"},
  {"internalType":"uint256","name":"amount","type":"uint256"}],"name":"transfer","outputs":[{"internalType":"bool","name":"","type":"bool"}],
  "stateMutability":"nonpayable","type":"function"
},{
  ...
  {"internalType":"address","name":"","type":"address"}],"name":"allowance","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],
...
async function mintTokens() {
  ...
  await contract.methods.mint(to, amount * 1e6).send({ from: account });
  updateBalance();
}
...
async function transferTokens() {
  ...
  await contract.methods.transfer(to, amount * 1e6).send({ from: account });
  updateBalance();
}
